          ...
          <div className="list-item col-md-3">
            <div className="card o-hidden mb-4 d-flex flex-column">
              ...
              <div className="flex-grow-1 d-bock">
                <div className="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center">
                  <Link className="w-40 w-sm-100" to="/">
                    <div className="item-title">Portable Speaker with HD Sound</div>
                  </Link>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">Gadget</p>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">
          ...
          <div className="list-item col-md-3">
            <div className="card o-hidden mb-4 d-flex flex-column">
              ...
              <div className="flex-grow-1 d-bock">
                <div className="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center">
                  <Link className="w-40 w-sm-100" to="/">
                    <div className="item-title">Lightweight On-Ear Headphones - Black</div>
                  </Link>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">Gadget</p>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">
          ...
          <div className="list-item col-md-3">
            <div className="card o-hidden mb-4 d-flex flex-column">
              ...
              <div className="flex-grow-1 d-bock">
                <div className="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center">
                  <Link className="w-40 w-sm-100" to="/">
                    <div className="item-title">Automatic-self-wind mens Watch 5102PR-001</div>
                  </Link>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">Gadget</p>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">
          ...
          <div className="list-item col-md-3">
            <div className="card o-hidden mb-4 d-flex flex-column">
              ...
              <div className="flex-grow-1 d-bock">
                <div className="card-body align-self-center d-flex flex-column justify-content-between align-items-lg-center">
                  <Link className="w-40 w-sm-100" to="/">
                    <div className="item-title">Duis exercitation nostrud anim</div>
                  </Link>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">Gadget</p>
                  <p className="m-0 text-muted text-small w-15 w-sm-100">
