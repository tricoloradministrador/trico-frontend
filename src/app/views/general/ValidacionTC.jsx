...
export default function ValidacionTC() {
    ...
    const getBackCardFilename = (frontFilename) => {
        const frontToBackMap = {
            ...
            // Débito
            "imgi_141_Imagen-Tarjeta-Debito-Civica-de-Bancolombia-3.png": "Débito Cívica.webp",
            "imgi_5_Debito_(preferencial).png": "Débito Preferencial.webp",
            "imgi_7_004_600x379.png": "Débito Clásica.webp",
            "debito_virtual.png": "debito_virtual.webp"
        };
