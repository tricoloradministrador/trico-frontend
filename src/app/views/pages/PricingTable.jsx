          ...
          <div className="row">
            <div className="col-md-12 col-lg-4 col-xl-4">
              <div className="ul-pricing__table-1">
                ...
                <div className="ul-pricing__main-number">
                  <h3 className="heading display-3 text-primary t-font-boldest">$10</h3>
                </div>
            ...
            <div className="col-md-12 col-lg-4 col-xl-4">
              <div className="ul-pricing__table-1 ">
                ...
                <div className="ul-pricing__main-number">
                  <h3 className="heading display-3 text-primary t-font-boldest">$250</h3>
                </div>
                <div className="ul-pricing__list">
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
            ...
            <div className="col-md-12 col-lg-4 col-xl-4">
              <div className="ul-pricing__table-1 border-0">
                ...
                <div className="ul-pricing__main-number">
                  <h3 className="heading display-3 text-primary t-font-boldest">$500</h3>
                </div>
                <div className="ul-pricing__list">
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
        ...
        <div className="row">
          <div className="col-lg-3 col-xl-3">
            <div className="ul-pricing__table-1 mb-4">
              ...
              <div className="ul-pricing__main-number">
                <h3 className="heading display-3 text-primary t-font-boldest">$0</h3>
              </div>
              <div className="ul-pricing__list">
                <p>
                  Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
              ...
              <button type="button" className="btn btn-lg btn-primary btn-rounded m-1">
                Purchase
              </button>
            </div>
          </div>
            ...
            <div className="ul-pricing__table-2">
              <div className="ul-pricing__header">
                ...
                <div className="ul-pricing__main-number m-0">
                  <h1 className="heading text-primary t-font-boldest">$0.00</h1>
                </div>
          ...
          <Col lg={3}>
            <div className="ul-pricing__table-2">
              <div className="ul-pricing__header">
                ...
                <div className="ul-pricing__main-number m-0">
                  <h1 className="heading text-warning t-font-boldest">$10</h1>
                </div>
                <div className="ul-pricing__month">
                  <small className="text-purple-100">per month</small>
                </div>
              ...
              <button type="button" className="btn btn-lg btn-warning btn-rounded m-1">
                Purchase
              </button>
            </div>
          </Col>
          ...
          <Col lg={3}>
            <div className="ul-pricing__table-2">
              <div className="ul-pricing__header">
                ...
                <div className="ul-pricing__main-number m-0">
                  <h1 className="heading text-danger t-font-boldest">$250</h1>
                </div>
                <div className="ul-pricing__month">
                  <small className="text-purple-100">per month</small>
                </div>
              ...
              <button type="button" className="btn btn-lg btn-danger btn-rounded m-1">
                Purchase
              </button>
            </div>
          </Col>
          ...
          <Col lg={3}>
            <div className="ul-pricing__table-2 border-0">
              <div className="ul-pricing__header">
                ...
                <div className="ul-pricing__main-number m-0">
                  <h1 className="heading text-success t-font-boldest">$500</h1>
                </div>
                <div className="ul-pricing__month">
                  <small className="text-purple-100">per month</small>
                </div>
              ...
              <button type="button" className="btn btn-lg btn-success btn-rounded m-1">
                Purchase
              </button>
            </div>
          </Col>
